...
public class GameRoom
{
    ...
    public void HandleSkill(Player player, C_Skill skillPacket)
    {
        ...
        if (player == null)
        {
            Console.WriteLine("return HandleSkill player is null");
            return;
        }
        ...
        lock (_lock)
        {
            ...
            {
                Console.WriteLine("return HandleSkill info.PosInfo.State is not Idle");
                return;
            }
            ...
            Console.WriteLine($"HandleSkill after Broadcast SkillId : {skillPacket.Info.SkillId}");
