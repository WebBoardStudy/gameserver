...
public class MultiplayersBuildAndRun
{
    ...
    #region Osx Tool Menu
    [MenuItem("Tools/Osx/Run Multiplayer/2 Players")]
    static void PerformOsxBuild2()
    {
        PerformOsxBuild(2);
    }
    
    [MenuItem("Tools/Osx/Run Multiplayer/3 Players")]
    static void PerformOsxBuild3()
    {
        PerformOsxBuild(3);
    }
    
    [MenuItem("Tools/Osx/Run Multiplayer/4 Players")]
    ...
    static void PerformOsxBuild(int playerCount)
    {
        ...
        {
            BuildPipeline.BuildPlayer(GetScenePaths(),
                "../Builds/Osx" + GetProjectName() + i.ToString() + "/" + GetProjectName() + i.ToString() + ".app",
